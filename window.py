...
class MainWindow(QTabWidget):
    ...
    def initUI(self):
        ...
        up_img_button = QPushButton("Select picture")
        det_img_button = QPushButton("Start process")
        ...
        self.webcam_detection_btn = QPushButton("Real-time webcam detection")
    ...
    def detect_img(self):
        ...
        print(source)
        if source == "":
            QMessageBox.warning(self, "please upload", "please upload image first")
        else:
            source = str(source)
